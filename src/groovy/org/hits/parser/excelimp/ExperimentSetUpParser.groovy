...
class ExperimentSetUpParser implements Parser{
    ...
    final static Set multiSourceActions=["OUTERPRODUCT_COLUMNS"]
    ...
    public StateAndQueue parse(StateAndQueue state) throws ParsingException{
        ...
        }else if (multiSourceActions.contains(action.getAction())){  //lei
            sheet=source.traverseCombine(doAction)
