...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="${createLinkTo(dir:'css',file:'base-min.css')}" />
    ...
    <script type="text/javascript" src="${createLinkTo(dir:'js', file:'jquery-1.5.2.js')}"></script>
    <script type="text/javascript" src="${createLinkTo(dir:'js', file:'timeline-api.js')}"></script>
    <style>
      #tl{
        width:100%;
        height:78%;
...
<body>
  ...
  <div class="ui-widget-header2" > 
    <table style="width: 100%; vertical-align:  middle ">
      <tr><td colspan="1" style=" text-align: left; color: #ffffff; cursor: pointer" >
          <a href="${createLink(uri:'/')}" >  <img alt="logo" src="${resource(dir: 'images/ui', file: 'excemplify.png')}" style="cursor: pointer" ></a></td></tr>
      <tr>
...
<h1>Log View For Experiment ${request.getParameter('experimentId')} </h1>

<div id='tl'></div>
<p>To move the Timeline: use the mouse scroll wheel, the arrow keys or grab and drag the Timeline.</p>
<sec:ifLoggedIn>
  <div style="position:relative" >
    <a  style="cursor: pointer" href="${createLink(uri: '/lab')}"><h3>Back User Home</h3></a>
  </div>
</sec:ifLoggedIn>
<sec:ifNotLoggedIn>
  <div style="position:relative" >
    <a  style="cursor: pointer" href="${createLink(uri: '/public')}"><h3>Back</h3></a>
  </div>
</sec:ifNotLoggedIn>
...
<script>        
           ...
           function onLoad() {
               ...
               eventSource1.loadJSON(${session.getAttribute('experimentLog')}, url); // The data was stored into the 
