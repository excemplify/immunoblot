...
<tr>
  ...
  <td style=" width:500px">
    <select name="template3" id="template3" style=" width:500px">
...
<!--<tr>
  ...
  <td>
    <select name="templateloading3"  id="templateloading3">
...
<tr>
  ...
  <td>
    <select name="templaterawdata3" id="templaterawdata3">
...
<tr>
  ...
  <td>
    <select name="templategelinspector3"  id="templategelinspector3">
